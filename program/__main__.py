...
# hello_world_fn = lambda_.Function('lambda_function',
...
#     __opts__=ResourceOptions(depends_on=[hello_world_fn]))
...
#     ),
#     opts=ResourceOptions(depends_on=[hello_world_fn, example_dep]),
# )
